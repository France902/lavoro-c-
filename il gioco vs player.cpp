...
int main()
{
    ...
    while (running)
    {
        ...
        switch (scelta)
        {
            case 'w': si = (si > 0) ? si - 1 : R - 1; break;
            case 's': si = (si < R - 1) ? si + 1 : 0; break;
            case 'a': sj = (sj > 0) ? sj - 1 : C - 1; break;
            case 'd': sj = (sj < C - 1) ? sj + 1 : 0; break;
            case 'q':
                if (si > 0 && sj > 0) { si--; sj--; }
        ...
        switch (scelta2)
        {
            case 'i': si2 = (si2 > 0) ? si2 - 1 : R - 1; break;
            case 'k': si2 = (si2 < R - 1) ? si2 + 1 : 0; break;
            case 'j': sj2 = (sj2 > 0) ? sj2 - 1 : C - 1; break;
            case 'l': sj2 = (sj2 < C - 1) ? sj2 + 1 : 0; break;
            case 'u':
        ...
        else if (possesso == 1 && si2 == pi && sj2 == pj)
        {
            possesso = 2;
        }
        else if (possesso == 2 && si == pi && sj == pj)
        {
            possesso = 1;
        }
